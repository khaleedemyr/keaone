...
const MENU_LABEL: Record<string, MsgKey> = {
  ...
  stocktransfers: 'menuStockTransfers',
  stockopnames: 'menuStockOpnames',
  stockadjustments: 'menuStockAdjustments',
  stockwaste: 'menuStockWaste',
  stockproduction: 'menuStockProduction',
  stockvaluation: 'menuStockValuation',
  ...
  approvalmatrix: 'menuApprovalMatrix',
  approvaldelegations: 'menuApprovalDelegations',
  fixedassets: 'menuFixedAssets',
  rfqs: 'menuRfqs',
  supplierpricelists: 'menuSupplierPriceLists',
...
const ROLE_GROUPS: { id: string; label: MsgKey; menus: string[] }[] = [
  ...
  { id: 'admin', label: 'appAdmin', menus: ['roles', 'company', 'outlets', 'modules', 'ops', 'logs', 'operators'] },
