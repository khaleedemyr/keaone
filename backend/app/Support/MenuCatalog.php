...
class MenuCatalog
{
    ...
    public static function tenant(): array
    {
        return [
            ...
            self::menu('stocktransfers', self::ACTIONS),
            self::menu('stockopnames', self::ACTIONS),
            self::menu('stockadjustments', self::ACTIONS),
            self::menu('stockwaste', self::ACTIONS),
            self::menu('stockproduction', self::ACTIONS),
            self::menu('stockvaluation', ['view']),
            self::menu('stocksettings', ['view', 'edit']),
            ...
            self::menu('financesettings', ['view', 'edit']),
